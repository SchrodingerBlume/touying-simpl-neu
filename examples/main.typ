...
#show: neu-theme.with(
  ...
  config-info(
    title: [Typst Slide Theme for NEU Based on Touying],
    subtitle: [基于 Touying 的东北大学 Typst 幻灯片模板],
...
#slide[
  - 您可以使用：
    ```sh
    typst init @preview/touying-neu
    ```
    来创建基于本模板的演示文稿项目。

  - 本模板基于 touying-sjtu 修改制作，特此致谢。

  - 本模板仓库位于 #link("https://github.com/SchrodingerBlume/touying-neu")，欢迎关注与贡献。
]
